...
public class ResponseDto 
{
    ...
    {
        ResponseDto responseBody = 
             new ResponseDto(ResponseCode.DUPLICATED_EMAILID,ResponseMessage.DUPLICATED_EMAILID);
         return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(responseBody);
    }
    ...
    {
        ResponseDto responseBody = 
             new ResponseDto(ResponseCode.DUPLICATED_NICKNAME,ResponseMessage.DUPLICATED_NICKNAME);
         return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(responseBody);
    }
    ...
    {
        ResponseDto responseBody = 
             new ResponseDto(ResponseCode.AUTH_NUMBER_SEND_FAILED,ResponseMessage.AUTH_NUMBER_SEND_FAILED);
    ...
    {
        ResponseDto responseBody = 
             new ResponseDto(ResponseCode.NO_EXIST_RESTAURANT,ResponseMessage.NO_EXIST_RESTAURANT);
         return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(responseBody);
    }
    ...
    {
        ResponseDto responseBody = 
            new ResponseDto(ResponseCode.NOT_FOUND_USER,ResponseMessage.NOT_FOUND_USER);
    ...
    public static ResponseEntity<ResponseDto> tokenCreationFailed()
    {
     ...
     {
         ResponseDto responseBody = 
             new ResponseDto(ResponseCode.RESET_LINK_SEND_FAILED,ResponseMessage.RESET_LINK_SEND_FAILED);
         return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(responseBody);
     }
     ...
     {
         ResponseDto responseBody = 
             new ResponseDto(ResponseCode.NO_EXIST_INQUIRY_BOARD,ResponseMessage.NO_EXIST_INQUIRY_BOARD);
         return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(responseBody);
     }
