...
public interface InquiryBoardRepository extends JpaRepository<InquiryBoardEntity,Integer> {
    ...
    @Query(value=
    "SELECT ib.inquiry_number inquiryNumber, ib.inquiry_status status, ib.inquiry_public inquiryPublic, ib.inquiry_title inquiryTitle, u.nickname inquiryWriterNickname, ib.inquiry_write_datetime inquiryWriteDatetime " +
